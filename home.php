            ...
            <div class="collapse navbar-collapse justify-content-end mr-5" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <div class="btn-group m-1">
                        <li class="nav-item">
                            <a class="nav-link btn btn-success active m-1" aria-current="page" href="home.php">View
                                Event</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            <div class="btn-group m-1">
                                <button type="button" class="btn btn-primary dropdown-toggle" id="navbarDropdown"
        ...
        <div class="table-responsive mt-5">
            ...
            ?>
                    <tr>
                        ...
                        <td><a href="update_event.php?eventID=<?= $rows['eventID'] ?>"
                                class="btn btn-success">Update</a>

                            <a onclick="checker()" href="php/delete.php?eventID=<?= $rows['eventID'] ?>"
